...
TECHNO_IMG = "https://telegra.ph/file/17f040b8bb06960f5ea49.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/No_Needz_Approval")],
                                                                                   [InlineKeyboardButton(text="ADD ROYAL ARMY BOT TO YOUR GROUP",
        ...
        update.effective_message.reply_text("Royal Abhi ZINDA Hai Sur👺")
